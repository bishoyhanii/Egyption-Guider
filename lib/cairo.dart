...
class _CairoState extends State<Cairo> {
  ...
  List<CityModel> data = [
    CityModel(
        ...
        "Giza Egypt",
        "From 9 a.m to 5 p.m",
        "Egyption: 20 EGP/ Ticket Egyption Student: 5 EGP/ Ticket Foreign: 80 EGP/ Ticket Foreigneer Student: 100 EGP",
        ),
    CityModel(
        "Egyption Muesum",
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                        'Ticket Price',style: TextStyle(
                      fontSize: 20,
                      fontWeight: FontWeight.bold,
                    )
                    ),
                    Text(
                        model.ticketPrice,style: TextStyle(
                      fontSize: 20,
                    )),
                    Divider(
                      color: Colors.teal,
                    ...
                    Text(
                        'Opening Hour',style: TextStyle(
                      fontSize: 20,
                      fontWeight: FontWeight.bold,
                    )),
                    Text("From 9 a.m to 5 p.m",style: TextStyle(
                      fontSize: 20,
                    )),
                    Text(
